...
<@layout.registrationLayout
  ...
  <#if section = "form">
    ...
    <div class="login-container">
      <div class="login-box">
            ...
            <#if realm.password>
              <form id="kc-form-login" onsubmit="login.disabled = true; return true;" action="${url.loginAction}" method="post">
                ...
                <div id="kc-form-buttons" class="${properties.kcFormGroupClass!}">
                  ...
                  <button tabindex="7"
                          class="btn-login ${properties.kcButtonClass!} ${properties.kcButtonBlockClass!} ${properties.kcButtonLargeClass!}"
        ...
        <#-- Registration (igual ao seu “registration-link”) -->
        <#if realm.password && realm.registrationAllowed && !registrationDisabled??>
          <div class="registration-link" id="kc-registration-container">
  ...
  <#elseif section = "socialProviders">
    <#-- social mantém padrão, só herdará nosso css -->
